package com.hutu.hutuojbackenduserservice.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;

import com.hutu.hutuojbackenduserservice.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "hutu";
    ...
    @Override
    public BaseResponse<Boolean> updateByUser(UserUpdateMyRequest userUpdateMyRequest, HttpServletRequest request) {
        User user = new User();
